...
## /impact
_Translate a ticket into the files that must change to deliver it, plus what it breaks and what is new_
...
## /show-graph
_Open the repo's code graph in a local browser window and report whether it matches HEAD_
